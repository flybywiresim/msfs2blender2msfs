...
def create_material(self, context):
    ...
    settings_node = None
    if (self.msfs_show_wetness_ao_texture or self.msfs_show_comp_texture):
        settings_node = utilities.make_settings_node(self)
        settings_node.location = 40, -370
        settings_node.width = 180
        
    if self.msfs_show_base_color_texture:
        base_color(
            self,
    ...
    if self.msfs_show_comp_texture:
        metallic_roughness(
            self,
    ...
    if self.msfs_show_normal_texture:
        normal(
            self,
    ...
    if self.msfs_show_emissive_texture:
        emission(
            self,
    ...
    if self.msfs_show_wetness_ao_texture:
        wetness_ao(
            self,
    ...
    if self.msfs_show_dirt_texture:
        dirt(
            self,
    ...
    if self.msfs_show_blend_mask_texture:
        # do blend mask last
        ...
        blend_mask(
            ...
            base_color_socket=detail_base_color_factor_socket,
            comp_socket=detail_comp_factor_socket,
            occlusion_socket=detail_occlusion_factor_socket,
            normal_socket=detail_normal_factor_socket,
        )
