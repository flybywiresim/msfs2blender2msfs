...
def specular_glossiness(mh, location, specular_socket, roughness_socket):
    x, y = location
    spec_factor = mh.pymat.extensions["KHR_materials_pbrSpecularGlossiness"].get(
        "specularFactor", [1, 1, 1]
    )
    gloss_factor = mh.pymat.extensions["KHR_materials_pbrSpecularGlossiness"].get(
        "glossinessFactor", 1
    )
    spec_gloss_texture = mh.pymat.extensions["KHR_materials_pbrSpecularGlossiness"].get(
