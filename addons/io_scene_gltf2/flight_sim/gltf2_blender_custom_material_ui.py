...
import bpy
from . import gltf2_blender_custom_material_behaviors

# Custom properties/panels
class MATERIAL_PT_MSFSMaterialPanel(bpy.types.Panel):
    """Panel with MSFS custom materials"""
    bl_label = "MSFS Materials"
    bl_idname = "MATERIAL_PT_MSFSMaterialPanel"
    ...
    def draw(self, context):
        ...
        if mat:
            box = layout.box()
            box.label(text = "Material Type", icon = "MATERIAL")
            box.prop(mat, "msfs_material_type", text = "Type", icon = "MATERIAL")
            ...
            if (mat.msfs_show_albedo == True or mat.msfs_show_metallic == True or mat.msfs_show_normal == True or mat.msfs_show_emissive == True or mat.msfs_show_detail_albedo == True or 
                ...
                if mat.msfs_show_detail_albedo == True:
                    ...
                    if mat.msfs_material_type == "windshield":
                ...
                if mat.msfs_show_detail_metallic == True:
                    ...
                    if mat.msfs_material_type == "geo_decal":
...
classes = (MATERIAL_PT_MSFSMaterialPanel,)
